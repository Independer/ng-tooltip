import { Component, Input, ElementRef, OnDestroy, OnInit, Output, EventEmitter, ChangeDetectorRef, ChangeDetectionStrategy, TemplateRef } from '@angular/core';
import { WindowSizeService, WindowSize, windowSizes } from './window-size.service';
import { position, offset } from './dom-helpers';
